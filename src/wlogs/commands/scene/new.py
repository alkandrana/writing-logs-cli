...
def get_scene_details(args, scene_path):
    return {
...
def parse_new_scene(scene_subparsers):
    ...
    create_parser.add_argument("--book", required=True, help="ID of the novel in which to create the scene (e.g., SOD)")
